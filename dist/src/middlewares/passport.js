...
passport_1.default.use('local', new passport_local_1.default(async (username, password, cb) => {
    try {
        const user = await user_model_1.default.findOne({ username: username, password: password });
        if (!user) {
