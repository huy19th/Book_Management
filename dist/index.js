...
const dashboard_router_1 = __importDefault(require("./src/routers/user/dashboard.router"));
const product_router_1 = __importDefault(require("./src/routers/user/product.router"));
const PORT = 3000;
...
app.use('/user', dashboard_router_1.default);
app.use('/user', product_router_1.default);
