...
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_y) {
        switch (_y.label) {
            ...
            case 1:
                user0 = new (_a.apply(User, [void 0, (_m.password = _y.sent(), _m.name = 'Eren Yeager', _m.phone = '0575400395', _m.address = 'Earth', _m.role = 'admin', _m)]))();
            ...
            case 2:
                ...
                return [4 /*yield*/, encrypt('123456')];
            case 3:
                user1 = new (_b.apply(User, [void 0, (_o.password = _y.sent(), _o.name = 'Mikasa Ackerman', _o.phone = '0397447651', _o.address = 'Earth', _o.role = 'user', _o)]))();
            ...
            case 4:
                ...
                return [4 /*yield*/, encrypt('123456')];
            case 5:
                user2 = new (_c.apply(User, [void 0, (_p.password = _y.sent(), _p.name = 'Armin Alert', _p.phone = '0833614637', _p.address = 'Earth', _p.role = 'user', _p)]))();
            ...
            case 6:
                ...
                return [4 /*yield*/, encrypt('123456')];
            case 7:
                user3 = new (_d.apply(User, [void 0, (_q.password = _y.sent(), _q.name = 'Annie Leonheart', _q.phone = '0800635667', _q.address = 'Earth', _q.role = 'user', _q)]))();
            ...
            case 8:
                ...
                return [4 /*yield*/, encrypt('123456')];
            case 9:
                user4 = new (_e.apply(User, [void 0, (_r.password = _y.sent(), _r.name = 'Reiner Braun', _r.phone = '0898917636', _r.address = 'Earth', _r.role = 'user', _r)]))();
            ...
            case 10:
                ...
                return [4 /*yield*/, encrypt('123456')];
            case 11:
                user5 = new (_f.apply(User, [void 0, (_s.password = _y.sent(), _s.name = 'Bertholdt Hoover', _s.phone = '0798459174', _s.address = 'Earth', _s.role = 'user', _s)]))();
            ...
            case 12:
                ...
                return [4 /*yield*/, encrypt('123456')];
            case 13:
                user6 = new (_g.apply(User, [void 0, (_t.password = _y.sent(), _t.name = 'Jean Kirschtein', _t.phone = '0748465841', _t.address = 'Earth', _t.role = 'user', _t)]))();
            ...
            case 14:
                ...
                return [4 /*yield*/, encrypt('123456')];
            case 15:
                user7 = new (_h.apply(User, [void 0, (_u.password = _y.sent(), _u.name = 'Levi Ackerman', _u.phone = '0374818608', _u.address = 'Earth', _u.role = 'user', _u)]))();
            ...
            case 16:
                ...
                return [4 /*yield*/, encrypt('123456')];
            case 17:
                user8 = new (_j.apply(User, [void 0, (_v.password = _y.sent(), _v.name = 'Hange Zoe', _v.phone = '0695351762', _v.address = 'Earth', _v.role = 'user', _v)]))();
            ...
            case 18:
                ...
                return [4 /*yield*/, encrypt('123456')];
            case 19:
                user9 = new (_k.apply(User, [void 0, (_w.password = _y.sent(), _w.name = 'Erwin Smith', _w.phone = '0910715236', _w.address = 'Earth', _w.role = 'user', _w)]))();
            ...
            case 20:
                ...
                return [4 /*yield*/, encrypt('123456')];
            case 21:
                user10 = new (_l.apply(User, [void 0, (_x.password = _y.sent(), _x.name = 'Floch Forster', _x.phone = '0884920510', _x.address = 'Earth', _x.role = 'user', _x)]))();
            ...
            case 116:
                _y.sent();
                order18 = new Order({ orderDate: '2021-10-2', deliverDate: '2021-10-3', user: user3._id, totalMoney: 240000 });
            ...
            case 128:
                _y.sent();
                order30 = new Order({ orderDate: '2022-11-30', deliverDate: '2022-12-2', user: user10._id, totalMoney: 170000 });
            ...
            case 132:
                _y.sent();
                order34 = new Order({ orderDate: '2021-1-2', deliverDate: '2021-1-5', user: user3._id, totalMoney: 390000 });
            ...
            case 161:
                _y.sent();
                order63 = new Order({ orderDate: '2022-1-29', deliverDate: '2022-2-2', user: user9._id, totalMoney: 131500 });
            ...
            case 174:
                _y.sent();
                order77 = new Order({ orderDate: '2022-3-2', deliverDate: '2022-3-4', user: user3._id, totalMoney: 85000 });
            ...
            case 191:
                _y.sent();
                order95 = new Order({ orderDate: '2022-12-2', deliverDate: '2022-12-3', user: user5._id, totalMoney: 247000 });
            ...
            case 195:
                _y.sent();
                order99 = new Order({ orderDate: '2022-9-29', deliverDate: '2022-10-2', user: user10._id, totalMoney: 222000 });
            ...
            case 204:
                _y.sent();
                order109 = new Order({ orderDate: '2021-9-2', deliverDate: '2021-9-4', user: user4._id, totalMoney: 98000 });
            ...
            case 206:
                _y.sent();
                order111 = new Order({ orderDate: '2021-1-31', deliverDate: '2021-2-2', user: user5._id, totalMoney: 415000 });
            ...
            case 209:
                _y.sent();
                order114 = new Order({ orderDate: '2021-3-2', deliverDate: '2021-3-2', user: user5._id, totalMoney: 75000 });
            ...
            case 241:
                _y.sent();
                order148 = new Order({ orderDate: '2022-12-20', deliverDate: '', user: user6._id, totalMoney: 405000 });
                return [4 /*yield*/, order148.save()];
            case 242:
                _y.sent();
                order149 = new Order({ orderDate: '2022-12-19', deliverDate: '', user: user2._id, totalMoney: 170000 });
                return [4 /*yield*/, order149.save()];
            case 243:
                _y.sent();
                order150 = new Order({ orderDate: '2022-12-13', deliverDate: '', user: user1._id, totalMoney: 220000 });
